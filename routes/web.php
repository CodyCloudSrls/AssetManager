...
use App\Http\Controllers\TenantServicesController;
...
Route::group(['middleware' => 'auth'], function () {
    ...
    */
    ...
    Route::get('erp/riconciliazione', [ErpController::class, 'riconciliazione'])->name('erp.riconciliazione')->middleware('tenant.feature:erp');
...
Route::group(['prefix' => 'admin/tenants', 'middleware' => ['auth']], function () {
    ...
    Route::get('/{tenant}/config', [TenantsController::class, 'editConfig'])->name('tenants.config.edit');
    Route::put('/{tenant}/config', [TenantsController::class, 'updateConfig'])->name('tenants.config.update');
    Route::get('/{tenant}/settings', [TenantsController::class, 'editSettings'])->name('tenants.settings.edit');
    Route::put('/{tenant}/settings', [TenantsController::class, 'updateSettings'])->name('tenants.settings.update');
    Route::get('/{tenant}/services', [TenantServicesController::class, 'index'])->name('tenants.services.index');
    Route::get('/{tenant}/services/create', [TenantServicesController::class, 'create'])->name('tenants.services.create');
    ...
    Route::delete('/{tenant}/services/{tenantService}', [TenantServicesController::class, 'destroy'])->name('tenants.services.destroy');
    ...
    Route::get('/{tenant}/mail', [TenantsController::class, 'editMail'])->name('tenants.mail.edit');
    Route::put('/{tenant}/mail', [TenantsController::class, 'updateMail'])->name('tenants.mail.update');
    Route::post('/{tenant}/mail/test', [TenantsController::class, 'sendTestMail'])->name('tenants.mail.test');
...
Route::group(['middleware' => 'web'], function () {
    ...
    Route::get('{object_type}/{id}/files/{file_id}',
        ...
        ->where(['object_type' => 'assets|audits|maintenances|hardware|models|users|locations|accessories|consumables|licenses|suppliers|customers|components|companies|departments|documents|tickets|contracts|bilanci']);
    ...
    Route::post('{object_type}/{id}/files/bulk-delete',
        ...
        ->where(['object_type' => 'assets|maintenances|hardware|models|users|locations|accessories|consumables|licenses|suppliers|customers|components|companies|departments|documents|tickets|contracts|bilanci']);
