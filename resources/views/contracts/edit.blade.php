...
<div class="form-group {{ $errors->has('tenant_service_ids') ? ' has-error' : '' }}">
    ...
    <div class="col-md-7">
        ...
        <select class="js-data-ajax" data-endpoint="tenantservices" data-placeholder="{{ trans('admin/tenantservices/general.field_label') }}" multiple name="tenant_service_ids[]" id="tenant_service_ids" aria-label="tenant_service_ids" style="width: 100%" data-company-id="{{ old('company_id', $contract->company_id ?: \App\Models\Company::preferredCompanySelectionId()) }}">
