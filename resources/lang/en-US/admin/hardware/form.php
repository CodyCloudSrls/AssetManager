...
return [
    ...
    'bulk_clear_supplier' => 'Clear the supplier (remove it from the selected assets)',
    'bulk_clear_customer' => 'Clear the customer (remove it from the selected assets)',
    'bulk_linked_ip_help' => 'This applies only to assets in the "Domain" category. Other assets do not change.',
