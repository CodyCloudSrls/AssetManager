...
return [
    ...
    'about_text' => 'Services are the tenant-level inventory used for ACN NIS categorization and can be linked to documents and customer contracts.',
    'help' => 'Inventory the services delivered by the tenant for ACN NIS categorization. Active services are exported in the ACN categorized list format.',
    ...
    'company_filter_clear' => 'Clear filter',
