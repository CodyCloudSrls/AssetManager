...
return [
    ...
    'ldap_sync_intro' => 'Click the button below to manually sync your LDAP users. Configure scheduled LDAP synchronization separately if you want this process to run automatically.',
