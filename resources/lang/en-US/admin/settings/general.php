...
return [
    ...
    'color_settings_help' => 'These settings will be used throughout the application. Users can still override link colors in their account preferences to match their readability requirements.',
    ...
    'footer_text_help' => 'This text will appear in the right-side footer. Links are allowed using GitHub Flavored Markdown. Line breaks, headers, images, and similar formatting may produce unpredictable results.',
    ...
    'link_dark_color_help' => 'Select a color that will provide enough contrast for people using dark mode.',
    'link_light_color' => 'Link Color for Light Mode',
    'link_light_color_help' => 'Select a color that will provide enough contrast for people using light mode.',
    ...
    'ldap_display_name_help' => 'If you have a separate displayName field in your LDAP/AD, map it here and it will be used for displaying users inside the application.',
    ...
    'ldap_activated_flag_help' => 'This value is used to determine whether a synced user can log in. <strong>It does not affect the ability to check items in or out to them</strong>, and should be the <strong>attribute name</strong> within your AD/LDAP, <strong>not the value</strong>. <br><br>If this field is set to a field name that does not exist in your AD/LDAP, or the value in the AD/LDAP field is set to <code>0</code> or <code>false</code>, <strong>user login will be disabled</strong>. If the value in the AD/LDAP field is set to <code>1</code> or <code>true</code> or <em>any other text</em>, the user can log in. When the field is blank in your AD, the <code>userAccountControl</code> attribute is used, which usually allows non-suspended users to log in.',
    ...
    'load_remote_help_text' => 'Uncheck this box if your installation cannot load scripts from the public internet. This prevents the application from trying to load avatars from Gravatar or other external sources.',
    ...
    'login_remote_user_custom_logout_url_help' => 'If a URL is provided here, users will be redirected to it after they log out. This can be useful to close sessions at your authentication provider correctly.',
    ...
    'show_images_in_email_help' => 'Uncheck this box if your installation is behind a VPN or closed network and users outside that network will not be able to load images served by the application in their emails.',
    'site_name' => 'Site Name',
    ...
    'support_footer_help' => 'Specify who sees the support and documentation links in the footer.',
    ...
    'width_w' => 'w',
    'height_h' => 'h',
    'show_url_in_emails' => 'Link to the application in emails',
    'show_url_in_emails_help_text' => 'Uncheck this box if you do not want email footers to link back to this application. This is useful if most of your users never log in directly.',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'This will attempt to delete cached barcodes. Use it if barcode settings or the application URL have changed. Barcodes will be regenerated on the next access.',
    ...
    'label2_2d_target_help' => 'The data that will be contained in the 2D barcode. This can link directly to the asset in the application or be one of the non-linked field values. If you use the prefix above, it will be prepended to this value.',
    ...
    'help_default_will_use' => 'The barcode value must comply with the selected barcode specification to be generated successfully.',
    'asset_id' => 'Asset ID',
    'data' => 'Data',
    'default' => 'Default',
    'none' => 'None',
