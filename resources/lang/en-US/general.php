...
return [
    'show_all' => 'Show All',
  'showing_recent_imports' => 'Showing the :shown most recent imports of :total.',
  'show_all_imports' => 'Show all (:count)',
  'showing_all_imports' => 'Showing all :count imports.',
  'show_recent_imports' => 'Show only the :count most recent',
    '2FA_reset' => '2FA reset',
    ...
    'superadmin_tooltip' => 'This user has platform-wide superadmin privileges',
    'superuser' => 'Tenant Superadmin',
    'superuser_tooltip' => 'This user has full administrative privileges within their tenant',
  ...
  'bulk_edit_count' => '{1} Bulk edit: 1 item selected.|[2,*] Bulk edit: :count items selected.',
    ...
    'select_all_pages_link' => 'Select all items across every page',
    'select_all_pages_done' => 'All items across every page are selected:',
    ...
    'template_visibility' => [
        ...
        'private' => 'Private to owner company',
        'descendants' => 'Share with descendant companies',
        'global' => 'Global system template',
    ],
    'template_visibility_help' => 'Private templates stay in the owner company tree. Descendant visibility lets child companies reuse them. Global templates are visible across the platform.',
    'component' => 'Component',
    ...
    'importing' => 'Importing',
    'importing_help' => 'The CSV should be comma-delimited and formatted with headers that match the expected import columns.',
    ...
    'ticket_public_reply' => 'Public reply added',
    'ticket_worklog_added' => 'Worklog added',
    'options' => 'Options',
    'preview' => 'Preview',
    'add_note' => 'Add Note',
  ...
  'nav_organization' => 'Organization',
    ...
    'webhook_test_msg' => 'Oh hai! It looks like your :app integration is working!',
    ...
    'upload_files_drag_drop' => 'Drag and drop files here, or',
    ...
    'show_superadmins' => 'Platform Superadmins',
    ...
    'footer_credit' => 'This platform is maintained by CodyCloud.',
