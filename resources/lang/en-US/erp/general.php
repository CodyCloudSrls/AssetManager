...
return [
    ...
    'fic' => [
        'title' => 'Fatture in Cloud connector',
        'configured' => 'Configured',
        'configured_help' => 'Token present. Run "php artisan fic:test" on the server to verify the connection and set the company to sync.',
