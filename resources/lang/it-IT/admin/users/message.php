...
return [
    ...
    'error' => [
        ...
        'delete_has_consumables_var' => 'Questo utente ha ancora un consumabile assegnato. Prima di procedere si prega di farlo restituire.|Questo utente ha ancora :count consumabili assegnati. Prima di procedere si prega di farli restituire.',
        'delete_has_documents_var' => 'Questo utente ha ancora un documento assegnato. Rimuovi o riassegna il collegamento prima di procedere.|Questo utente ha ancora :count documenti assegnati. Rimuovi o riassegna i collegamenti prima di procedere.',
        'delete_has_tickets_var' => 'Questo utente ha ancora un ticket assegnato. Riassegnalo o chiudilo prima di procedere.|Questo utente ha ancora :count ticket assegnati. Riassegnali o chiudili prima di procedere.',
