...
return [
    ...
    'archived' => 'Archiviato',
    'overview_title' => 'Panoramica beni',
    'overview_intro' => 'Vista a cruscotto dei beni raggruppati per categoria e per set di campi. Clicca una card per aprire la lista filtrata.',
    'overview_full_list' => 'Lista completa',
    'overview_view_assets' => 'Vedi i beni',
    'overview_empty' => 'Nessun bene registrato.',
    'overview_fields' => 'Set di campi',
    'overview_fields_help' => 'Beni raggruppati per set di campi personalizzati del modello (es. "Asset Virtuali" per IP e domini).',
    'advanced_filters' => 'Filtri avanzati',
    'advanced_filters_active' => 'attivi',
    'advanced_filters_apply' => 'Applica filtri',
    'advanced_filters_reset' => 'Azzera',
    'advanced_filters_all' => '— Tutte —',
    'advanced_filters_field' => 'Campo personalizzato',
    'advanced_filters_field_choose' => '— Scegli un campo —',
    'advanced_filters_field_value' => 'Valore contiene…',
