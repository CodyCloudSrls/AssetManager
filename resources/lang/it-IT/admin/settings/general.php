...
return [
    ...
    'color_settings_help' => 'Queste impostazioni saranno utilizzate in tutta l\'applicazione. Gli utenti possono comunque modificare i colori dei link nelle preferenze del proprio account per soddisfare le proprie esigenze di leggibilità.',
    ...
    'eula_markdown' => 'Questa EULA consente l\'uso di GitHub Flavored Markdown.',
    ...
    'footer_text_help' => 'Questo testo verrà visualizzato nel piè di pagina a destra. I collegamenti sono consentiti usando GitHub Flavored Markdown. Interruzioni di riga, intestazioni, immagini e formattazioni simili possono produrre risultati imprevedibili.',
    ...
    'link_dark_color_help' => 'Seleziona un colore che fornisca un contrasto sufficiente per le persone che utilizzano la modalità scura.',
    'link_light_color' => 'Colore del link per la modalità chiara',
    'link_light_color_help' => 'Seleziona un colore che fornisca un contrasto sufficiente per le persone che utilizzano la modalità chiara.',
    ...
    'ldap_mapping_help' => 'Se i campi non sono sincronizzati correttamente, prova a usare la versione <strong>in minuscolo</strong> dei nomi dei campi. Display Name (<code>displayName</code>) nel tuo LDAP/AD dovrebbe essere mappato qui come <code>displayname</code>, <code>givenName</code> come <code>givenname</code>, <code>sAMAccountName</code> come <code>samaccountname</code> e cosi via.',
    ...
    'ldap_display_name_help' => 'Se hai un campo displayName separato nel tuo LDAP/AD, mappalo qui e verrà utilizzato per mostrare gli utenti all\'interno dell\'applicazione.',
    ...
    'ldap_activated_flag_help' => 'Questo valore viene utilizzato per determinare se un utente sincronizzato può accedere. <strong>Non influisce sulla capacità di effettuare il check in o il checkout dei beni</strong> e dovrebbe essere il <strong>nome dell\'attributo</strong> nel tuo AD/LDAP, <strong>non il valore</strong>. <br><br>Se questo campo è impostato su un nome di campo che non esiste nel tuo AD/LDAP, oppure il valore nel campo AD/LDAP è impostato su <code>0</code> o <code>false</code>, <strong>il login sarà disabilitato</strong>. Se il valore nel campo AD/LDAP è impostato a <code>1</code>, <code>true</code> o <em>qualsiasi altro testo</em>, l\'utente può accedere. Quando il campo è vuoto nel tuo AD, viene usato l\'attributo <code>userAccountControl</code>, che di solito consente l\'accesso agli utenti non sospesi.',
    ...
    'load_remote_help_text' => 'Deseleziona questa casella se la tua installazione non può caricare script da Internet. Questo impedirà all\'applicazione di tentare il caricamento degli avatar da Gravatar o da altre fonti esterne.',
    ...
    'login_note_help' => 'Puoi includere alcune frasi nella schermata di login, ad esempio per aiutare le persone che hanno trovato un dispositivo perso o rubato. Questo campo accetta GitHub Flavored Markdown.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Se qui viene indicato un URL, gli utenti verranno reindirizzati a questo indirizzo dopo il logout. Questo è utile per chiudere correttamente le sessioni presso il provider di autenticazione.',
    ...
    'show_images_in_email_help' => 'Deseleziona questa casella se l\'installazione si trova dietro una VPN o una rete chiusa e gli utenti esterni non saranno in grado di caricare le immagini fornite dall\'applicazione nelle loro email.',
    'site_name' => 'Nome sito',
    ...
    'snipe_version' => 'Versione applicazione',
    'support_footer' => 'Supporto per i collegamenti a piè di pagina ',
    'support_footer_help' => 'Specifica chi vede i collegamenti al supporto e alla documentazione nel piè di pagina.',
    'version_footer' => 'Versione a piè di pagina ',
    'version_footer_help' => 'Specifica chi può vedere la versione dell\'applicazione e il numero di build.',
    ...
    'width_w' => 'l',
    'height_h' => 'h',
    'show_url_in_emails' => 'Collegamento all\'applicazione nelle email',
    'show_url_in_emails_help_text' => 'Deseleziona questa casella se non desideri inserire un collegamento all\'applicazione nei piè di pagina delle email. È utile se la maggior parte degli utenti non accede mai direttamente.',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'Questo tenterà di eliminare i codici a barre in cache. In genere si usa quando le impostazioni dei codici a barre o l\'URL dell\'applicazione sono cambiati. I codici a barre verranno rigenerati al prossimo accesso.',
    ...
    'label2_2d_target_help' => 'I dati che saranno contenuti nel codice a barre 2D. Possono collegarti direttamente al bene nell\'applicazione oppure essere uno dei valori di campo non collegati. Se usi il prefisso qui sopra, verrà anteposto a questo valore.',
    ...
    'help_default_will_use' => 'Il valore del codice a barre deve essere conforme alla specifica selezionata per poter essere generato correttamente.',
    'asset_id' => 'ID Bene',
    'data' => 'Dati',
    'default' => 'Predefinito',
    'none' => 'Niente',
