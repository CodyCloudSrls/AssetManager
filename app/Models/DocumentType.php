...
class DocumentType extends SnipeModel
{
    ...
    protected $rules = [
        'name' => 'required|string|max:255|unique:document_types,name,NULL,id,deleted_at,NULL',
        'slug' => 'nullable|string|max:255|unique:document_types,slug,NULL,id,deleted_at,NULL',
