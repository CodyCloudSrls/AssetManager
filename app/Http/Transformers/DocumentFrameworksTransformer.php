...
class DocumentFrameworksTransformer
{
    ...
    public function transformDocumentFramework(DocumentFramework $documentFramework): array
    {
        return [
            ...
            'compliance_domain' => e($documentFramework->compliance_domain),
            'compliance_domain_label' => e(DocumentFramework::complianceDomainOptions()[$documentFramework->compliance_domain] ?? $documentFramework->compliance_domain),
