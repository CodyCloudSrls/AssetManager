...
class AssetsTransformer
{
    ...
    public function transformAsset(Asset $asset)
    {
        ...
        $array = [
            ...
            'nis_relevant' => (bool) $asset->nis_relevant,
            'nis_inventory_scope' => e($asset->nis_inventory_scope),
            'nis_inventory_scope_label' => e($asset->nis_inventory_scope_label),
            'nis_service_impact' => e($asset->nis_service_impact),
            'nis_service_impact_label' => e($asset->nis_service_impact_label),
            ...
            'nis_notes' => ($asset->nis_notes) ? Helper::parseEscapedMarkedownInline($asset->nis_notes) : null,
