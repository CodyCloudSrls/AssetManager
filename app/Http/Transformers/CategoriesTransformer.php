    ...
    public function transformCategory(?Category $category = null)
    {
        ...
        if ($category) {
            $array = [
                ...
                'nis_inventory_required' => (bool) $category->nis_inventory_required,
                'nis_inventory_scope' => e($category->nis_inventory_scope),
                'nis_inventory_scope_label' => e($category->nis_inventory_scope_label),
