    ...
    public function transformSupplier(?Supplier $supplier = null)
    {
        if ($supplier) {
            $array = [
                ...
                'nis_assessment_method' => e($supplier->nis_assessment_method),
                'nis_assessment_method_label' => e($supplier->nis_assessment_method_label),
                'nis_assessment_outcome' => e($supplier->nis_assessment_outcome),
                'nis_assessment_outcome_label' => e($supplier->nis_assessment_outcome_label),
