...
class DocumentFrameworkRequirementsTransformer
{
    ...
    public function transformRequirement(DocumentFrameworkRequirement $requirement): array
    {
        return [
            ...
            'risk_level' => e($requirement->effective_risk_level),
            ...
            'parent_requirement_codes' => e($requirement->parent_requirement_codes),
            'parents' => $requirement->parent_requirements->map(fn ($parent) => [
                'id' => (int) $parent->id,
                'code' => e($parent->code),
            ...
            'documents_count' => (int) ($requirement->documents_count ?? $requirement->documents()->count()),
            'primary_documents_count' => (int) ($requirement->primary_documents_count ?? $requirement->primaryDocuments()->count()),
            'healthy_primary_documents_count' => (int) ($requirement->healthy_primary_documents_count ?? $requirement->healthyPrimaryDocumentsQuery()->count()),
