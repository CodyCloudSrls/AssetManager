    ...
    public static function definitions(): array
    {
        return [
            ...
            [
                ...
                'permissions' => self::permissionMap([
                    'reports.nis_risk_matrix.view', 'reports.nis_real_coverage.view',
                    'documents.view', 'documents.create', 'documents.edit', 'documents.files.view', 'documents.files',
            ...
            [
                ...
                'notes' => 'Read-only document and NIS audit profile. Can inspect NIS reports, controlled documents, framework metadata, and limited tenant context without operational write permissions or file management.',
                'permissions' => self::permissionMap([
                    'reports.nis_risk_matrix.view', 'reports.nis_real_coverage.view',
                    'assets.view',
                    'documents.view', 'documents.files.view',
